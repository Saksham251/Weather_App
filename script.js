...
const errorBtn = document.querySelector('[data-apiErrorBtn]');
...
function switchTab(clickedTab){
    ...
    if(clickedTab!=currentTab){
        ...
        if(!searchForm.classList.contains("active")){
            ...
            // now switching to your weather
            searchForm.classList.remove("active");
            userInfoContainer.classList.remove("active");
            //  displaying weather by using latitude and longitude stored already
            getfromSessionStorage();
        }
    }
}
...
// check if coordinates are already present in the session
